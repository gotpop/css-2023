...
function DropdownMenuItem({ children, ...props }) {
  return (
    <DropdownMenu.Item
      {...props}
      className={"group bg-white hover:bg-gray-700 hover:text-gray-200 text-xs rounded flex items-center h-6 px-1 pl-6 relative select-none" + (props.disabled ? " text-gray-500" : "")}
    >
      {children}
    </DropdownMenu.Item>
  );
...
function DropdownMenuCheckboxItem({ children, ...props }) {
  return (
    <DropdownMenu.CheckboxItem {...props} className="group bg-white hover:bg-gray-700 hover:text-gray-200 text-xs rounded flex items-center h-6 px-1 pl-6 relative select-none">
      {children}
...
function DropdownMenuItemIndicator({ children, ...props }) {
  return (
    <DropdownMenu.ItemIndicator {...props} className="absolute left-0 w-6 inline-flex items-center justify-center">
      {children}
...
function DropdownMenuRadioItem({ children, ...props }: { children: React.ReactNode; value: string }) {
  return (
    <DropdownMenu.RadioItem {...props} className="bg-white hover:bg-gray-700 hover:text-gray-200 text-xs rounded flex items-center h-6 px-1 pl-6 relative select-none">
      {children}
...
export default function Home() {
  ...
  return (
    <div className="h-screen w-full flex flex-col space-y-4 items-center justify-center bg-gradient-to-r from-cyan-500 to-blue-500">
      ...
      <DropdownMenu.Root>
        <DropdownMenu.Trigger asChild className="bg-white text-xs rounded-3xl flex items-center h-8 px-2 relative select-none">
          <button aria-label="Customise options" className="h-8 w-8 inline-flex items-center justify-center shadow-lg">
            <HamburgerMenuIcon />
          </button>
        ...
        <DropdownMenu.Content sideOffset={5} className="bg-white rounded p-1 shadow-lg">
          ...
          <DropdownMenu.Sub>
            ...
            <DropdownMenu.SubContent sideOffset={2} alignOffset={-5} className="bg-white rounded p-1 shadow-lg">
              <DropdownMenuItem>
          ...
          <Separator />
          <DropdownMenu.Label className="pl-6 leading-6 text-xs text-gray-700">Contributors</DropdownMenu.Label>
